...
function ModalEdit(props) {
  ...
  const handleUserEdit = async () => {
    ...
    let response = await updateProductOfSupplierService(inputForm)
      ...
      <Modal.Body>
        <div className="container">
          <div className="row">
            ...
            <div className="col-6">
              <label>quantity</label>
              <input value={inputForm.quantity} onChange={(e) => handleOnchange('categoryId', e)} className="form-control" type="text" />
              <p style={{ color: 'red' }}>{errMessage.quantity}</p>
            </div>
